...
import {
  Knife4jOAS2AdditionalModel,
  Knife4jOAS2AdditionalModelClassFinder,
} from "./oas2/OAS2AdditionalModel";
    ...
    if (!that.currentInstance.load) {
      ...
      if (that.desktop) {
        reqHeaders = Object.assign({}, reqHeaders, {
          "knife4j-gateway-code": that.desktopCode,
        });
      }
      if (KUtils.checkUndefined(this.currentInstance.header)) {
        // Knife4j自研Aggreration微服务聚合组件请求头
        reqHeaders = Object.assign({}, reqHeaders, {
          "knife4j-gateway-request": that.currentInstance.header,
        });
      }
      if (KUtils.checkUndefined(this.currentInstance.basicAuth)) {
        reqHeaders = Object.assign({}, reqHeaders, {
          "knife4j-gateway-basic-request": that.currentInstance.basicAuth,
        });
      }
...
SwaggerBootstrapUi.prototype.dispatchSettings = function () {
  this.store.dispatch(
    "globals/setAfterScript",
    this.settings.enableAfterScript
  );
  this.store.dispatch(
    "globals/setReloadCacheParameter",
    this.settings.enableReloadCacheParameter
  );
  // add 2022.8.11 xiaoymin
  this.store.dispatch(
    "globals/setResponseCode",
    this.settings.enableResponseCode
  );
...
SwaggerBootstrapUi.prototype.mergeLocalSecurityContext = function () {
  ...
  that.localStore
    .getItem(Constants.globalSecurityParameterObject)
    .then((gbp) => {
      ...
      if (KUtils.arrNotEmpty(backArr)) {
        ...
        that.localStore.getItem(key).then((currentSecurity) => {
          ...
          that.localStore.setItem(
            Constants.globalSecurityParameterObject,
  ...
  if (KUtils.checkUndefined(openapi)) {
    ...
    if (KUtils.checkUndefined(openapi["x-setting"])) {
      ...
      if (KUtils.arrNotEmpty(settings)) {
        ...
        if (that.i18nFlag) {
          // 外部i18n传参
          mergeSetting = Object.assign({}, mergeSetting, {
            language: that.i18n,
          });
        }
        that.settings = mergeSetting;
...
SwaggerBootstrapUi.prototype.openDocuments = function (data) {
  ...
  if (KUtils.checkUndefined(openapi)) {
    ...
    if (KUtils.arrNotEmpty(openapi["x-markdownFiles"])) {
      ...
      mkdFiles.forEach((mdTag) => {
        ...
        if (KUtils.arrNotEmpty(mdTag["children"])) {
          ...
          swuFileChildrens.forEach((mdFile) => {
            ...
            // 缓存对象
            currentInstanceMarkdownFileMap[mdf.id] = KUtils.getValue(
              mdFile,
              "content",
              "",
              true
      ...
      that.localStore.setItem(
        currentCacheFilesKey,
        currentInstanceMarkdownFileMap
      );
    }
  }
};
...
SwaggerBootstrapUi.prototype.updateCurrentInstanceSecuritys = function () {
  var that = this;
  if (
    that.currentInstance.securityArrs != null &&
    that.currentInstance.securityArrs.length > 0
  ) {
    // 判断是否有缓存cache值
...
SwaggerBootstrapUi.prototype.basicInfoOAS2 = function (menu) {
  ...
  if (menu != null && menu != undefined) {
    ...
    that.currentInstance.basePath = KUtils.getValue(
      menu,
      "basePath",
      "/",
      true
...
SwaggerBootstrapUi.prototype.basicInfoOAS3 = function (menu) {
  ...
  if (KUtils.checkUndefined(menu)) {
    if (
      menu.hasOwnProperty("servers") &&
      KUtils.checkUndefined(menu["servers"])
    ) {
 ...
 * @param {*} oas2 是否v2版本
 */
SwaggerBootstrapUi.prototype.analysisDefinitionAsync = function (
  menu,
  swud,
  oas2
) {
 ...
 * @param {*} oas2
 */
SwaggerBootstrapUi.prototype.analysisDefinitionAsyncOAS2 = function (
  menu,
  swud,
  oas2
) {
  ...
  if (
    ...
    menu != undefined &&
    menu.hasOwnProperty("definitions")
  ) {
        ...
        if (KUtils.checkUndefined(value)) {
          ...
          if (value.hasOwnProperty("properties")) {
            ...
            for (var property in properties) {
              ...
              spropObj.description = KUtils.propValue(
                "description",
                propobj,
                ""
              );
              ...
              if (propobj.hasOwnProperty("enum")) {
                ...
                spropObj.description = KUtils.enumAvalibleLabel(
                  that.i18nInstance,
                  spropObj.enum,
              ...
              if (propobj.hasOwnProperty("type")) {
                  ...
                  if (type == "object") {
                    if (propobj.hasOwnProperty("additionalProperties")) {
                      ...
                      let addtionalClassFinder =
                        new Knife4jOAS2AdditionalModelClassFinder(
                          addpties,
                          oas2
                        );
                      ...
                      if (KUtils.strNotBlank(addtionalName)) {
                        ...
                        if (addtionalName != name) {
                          addTempValue = that.findRefDefinition(
                            addtionalName,
                            definitions,
                            false,
                            globalArr,
                        ...
                        let addionalModel = new Knife4jOAS2AdditionalModel(
                          addpties,
                          addtionalName,
                          addTempValue
                        );
                ...
                if (propobj.hasOwnProperty("$ref")) {
                  ...
                  if (regex.test(ref)) {
                    ...
                    globalArr.push(name);
                    if (refType != name) {
                      propValue = that.findRefDefinition(
                        refType,
                        definitions,
                        false,
                        globalArr,
 ...
 * @param {*} oas2
 */
SwaggerBootstrapUi.prototype.analysisDefinitionAsyncOAS3 = function (
  menu,
  swud,
  oas2
) {
  ...
  if (KUtils.checkUndefined(menu) && menu.hasOwnProperty("components")) {
    ...
    if (
      KUtils.checkUndefined(components) &&
      components.hasOwnProperty("schemas")
    ) {
          ...
          if (value.hasOwnProperty("properties")) {
            ...
            for (var property in properties) {
                ...
                if (propobj.hasOwnProperty("example")) {
                  ...
                  if (type == "object") {
                    ...
                    if (propobj.hasOwnProperty("properties")) {
                      ...
                      let oas3PropertyReader = new OAS3SchemaPropertyReader(
                        propobj
                      );
                      oas3PropertyReader.readBasicProperty(
                        tempSwdf,
                        that,
                        definitions,
                        oas2
              ...
              if (KUtils.checkUndefined(propobj.title)) {
                if (
                  KUtils.checkUndefined(spropObj.description) &&
                  spropObj.description != ""
                ) {
                  spropObj.description =
                    propobj.title + ":" + spropObj.description;
                } else {
...
SwaggerBootstrapUi.prototype.analysisDefinitionRefModelOAS3 = function (menu) {
  ...
  if (
    ...
    typeof menu != "undefined" &&
    menu != undefined &&
    menu.hasOwnProperty("components")
  ) {
    var components = menu["components"];
    if (
      KUtils.checkUndefined(components) &&
 ...
 */
SwaggerBootstrapUi.prototype.analysisDefinitionRefTableModel = function (
  instanceId,
  treeTableModel
) {
            ...
            for (var key in definitions) {
              if (key == originalTreeTableModel.name) {
                ...
                if (KUtils.checkUndefined(def)) {
                  ...
                  originalTreeTableModel.description = KUtils.propValue(
                    "description",
                    def,
                    ""
                  );
                  if (def.hasOwnProperty("properties")) {
                    ...
                    // console.log(props)
                    // 获取required属性
                    var requiredArrs = def.hasOwnProperty("required")
                      ? def["required"]
                      : new Array();
                    for (var pkey in props) {
                      ...
                      if (p.hasOwnProperty("enum")) {
                        description = KUtils.enumAvalibleLabel(
                          that.i18nInstance,
                          p.enum,
                          description
                        );
                      ...
                      // 判断类型是否基础类型
                      if (
                        KUtils.checkUndefined(p.refType) &&
                        !KUtils.checkIsBasicType(p.refType)
                      ) {
                        ...
                        // console.log(refp)
                        // 属性名称不同,或者ref类型不同
                        var deepDef = that.getOriginalDefinitionByName(
                          p.refType,
                          definitions
                        );
                        ...
                        if (!KUtils.checkUndefined(refp.description)) {
                          //console.log("aa")
                          refp.description = KUtils.propValue(
                            "description",
                            deepDef,
                            ""
                          );
                        ...
                        if (KUtils.checkUndefined(deepDef)) {
                          if (!refp.parentTypes.includes(p.refType)) {
                            deepSwaggerModelsTreeTableRefParameter(
                              refp,
                              definitions,
                              deepDef,
                              originalTreeTableModel,
                              that,
                              oas2
                            );
                          }
 ...
 */
SwaggerBootstrapUi.prototype.getOriginalDefinitionByName = function (
  name,
  definitions
) {
  var def = { name: name };
  for (var key in definitions) {
    if (key == name) {
      ...
      def["description"] = KUtils.propValue(
        "description",
        definitions[key],
        ""
      );
 ...
 * @param {*} oas2
 */
SwaggerBootstrapUi.prototype.getSwaggerModelRefArray = function (
  propobj,
  oas2
) {
  var arrayFlag = false;
    ...
    if (KUtils.checkIsBasicType(type)) {
      ...
      if (type == "object") {
        if (propobj.hasOwnProperty("additionalProperties")) {
          var addpties = propobj["additionalProperties"];
          // 判断是否additionalProperties中还包含additionalProperties属性
          let addtionalClassFinder = new Knife4jOAS2AdditionalModelClassFinder(
            addpties,
            oas2
          );
          //var addtionalName = this.deepAdditionalProperties(addpties, oas2);
    ...
    for (var key in definitions) {
      if (key == deepDef.name) {
        ...
        if (KUtils.checkUndefined(def)) {
          ...
          if (
            tmpDescriptionValue != null &&
            !KUtils.checkUndefined(parentRefp.description)
          ) {
          ...
          if (def.hasOwnProperty("properties")) {
            ...
            for (var pkey in props) {
              ...
              if (
                ...
                refp.schema = true;
                // 属性名称不同,或者ref类型不同
                var childdeepDef = that.getOriginalDefinitionByName(
                  p.refType,
                  definitions
                );
                if (!refp.parentTypes.includes(p.refType)) {
...
SwaggerBootstrapUi.prototype.analysisDefinition = function (menu) {
  ...
  that.normalizeOAS3AllOf(that.currentInstance.swaggerData);
  // 解析definition
  // 放弃解析所有的Model结构
  ...
  if (
    ...
    tags.forEach(function (tag) {
      ...
      var swuTag = new SwaggerBootstrapUiTag(
        KUtils.toString(tag.name, "").replace(/\//g, "-"),
        tagdes
      );
  ...
  if (
    ...
    async.forEachOf(paths, function (pathObject, path, callback) {
      ...
      _supportMethods.forEach(function (method) {
        if (pathObject.hasOwnProperty(method)) {
          ...
          if (apiInfo != null) {
            var ins = that.createApiInfoInstance(
              path,
              method,
              apiInfo,
              appendBaePathFlag
    ...
    if (that.settings.enableFilterMultipartApis) {
      ...
      for (var url in that.currentInstance.pathFilters) {
        ...
        // that.log('')
        newPathArr = newPathArr.concat(
          saf.api(that.settings.enableFilterMultipartApiMethodType)
        );
      }
      that.log("重新赋值。。。。。");
      ...
      that.currentInstance.paths.forEach((methodApi) => {
        ...
        methodApi.tags.forEach((tagName) => {
          if (tagName == tag.name) {
            // 是否存在
            if (
              !that.currentInstance.cacheInstance.cacheApis.includes(
                methodApi.id
              )
            ) {
              // }
...
SwaggerBootstrapUi.prototype.readSecurityContextSchemes = function (menu) {
  if (this.currentInstance.oas2()) {
    if (
      ...
      typeof menu != "undefined" &&
      menu != undefined &&
      menu.hasOwnProperty("securityDefinitions")
    ) {
    ...
    if (KUtils.checkUndefined(menu) && menu.hasOwnProperty("components")) {
      ...
      if (
        KUtils.checkUndefined(components) &&
        components.hasOwnProperty("securitySchemes")
      ) {
 ...
 * @param {*} menu
 */
SwaggerBootstrapUi.prototype.readSecurityContextSchemesCommon = function (
  securityDefinitions
) {
  var that = this;
        ...
        if (this.currentInstance.oas2()) {
          ...
          */
          ...
          for (var flow in sdobj.flows) {
            let oauth2Reader = new Knife4jOAS3OAuth2Reader(
              flow,
              that.currentInstance.id,
              sdobj.flows[flow]
            );
...
SwaggerBootstrapUiOAuth2.prototype.syncOAuth = function () {
  ...
  if (window.localStorage) {
    ...
    if (KUtils.strNotBlank(value)) {
      ...
      this.accessToken =
        KUtils.getValue(storageObject, "tokenType", "Bearer", true) +
        " " +
    ...
    for (var name in that.currentInstance.refTreeTableModels) {
      ...
      if (KUtils.arrNotEmpty(param.params)) {
        param.params.forEach(function (ps) {
          ...
          if (ps.schema) {
            // 查找当前ps的属性值
            deepTreeTableSchemaModel(
              model,
              that.currentInstance.refTreeTableModels,
              ps,
              newparam
            );
          }
...
SwaggerBootstrapUi.prototype.createDetailMenu = function (addFlag) {
  ...
  // 是否有全局参数
  if (
    KUtils.arrNotEmpty(that.currentInstance.securityArrs) ||
    KUtils.checkUndefined(that.currentInstance.oauths)
  ) {
  ...
  if (that.settings.enableSwaggerModels) {
    // 重命名model
    var swaggerModelName = KUtils.getValue(
      that.settings,
      "swaggerModelName",
      "Swagger Models",
      true
    ...
    if (len > 0) {
      ...
      tag.childrens.forEach(function (children) {
        ...
        var tabSubMenu = {
          ...
          groupId: groupId,
          key: md5(
            groupName + children.summary + children.operationId + children.id
          ),
          name: children.summary,
          description: children.description,
          path: children.operationId + "_" + children.id,
          component: "ApiInfo",
 ...
 * @param prop
 */
SwaggerBootstrapUi.prototype.checkPropertiesExists = function (
  properties,
  prop
) {
  var flag = false;
...
SwaggerBootstrapUi.prototype.analysisAllOfOAS2 = function (allOf) {
  ...
  const originalObjCopy = JSON.parse(
    JSON.stringify(definitions[originalObjName])
  );
  // 需要修补的属性
  const patchProperties = allOf[1].properties;
  // 合并
  originalObjCopy.properties = Object.assign(
    originalObjCopy.properties,
    patchProperties
  );
  // 新的模型名
    ...
    if (patchProperties.hasOwnProperty(key)) {
      ...
      if (element.hasOwnProperty("$ref")) {
        ...
        if (!elementObjNameMatch) {
          that.error(
            "Unable to parse element object name from " + element.$ref
          );
          return;
        }
      ...
      if (element.hasOwnProperty("items")) {
        ...
        if (!elementObjNameMatch) {
          that.error(
            "Unable to parse element object name from " + element.items.$ref
          );
          return;
        }
        const elementObjName = elementObjNameMatch[1];
  ...
  // 检查definitions是否已有
  if (definitions[newModelName]) return newModelName;
  ...
  if (!swpinfo.init) {
    ...
    if (apiInfo.hasOwnProperty("parameters")) {
      ...
      pameters.forEach(function (m) {
        ...
        if (swpinfo.includeParameters != null) {
          // 直接判断include的参数即可
          if (
            KUtils.filterIncludeParameters(
              inType,
              originalName,
              swpinfo.includeParameters
            )
          ) {
          ...
          if (
            KUtils.filterIgnoreParameters(
              inType,
              originalName,
              swpinfo.ignoreParameters
            )
          ) {
            that.assembleParameter(m, swpinfo);
          }
    ...
    if (typeof apiInfo.responses != "undefined" && apiInfo.responses != null) {
      ...
      for (var status in resp) {
        ...
        var rptype = null;
        if (
          rescrobj.hasOwnProperty("schema") &&
          KUtils.checkUndefined(rescrobj["schema"])
        ) {
            ...
            if (t == "array") {
              ...
              if (schema.hasOwnProperty("properties")) {
                ...
                for (var property in properties) {
                  ...
                  spropObj.example = KUtils.getExample("example", propobj, "");
                  spropObj.format = KUtils.propValue("format", propobj, "");
                  spropObj.required = KUtils.propValue(
                    "required",
                    propobj,
                    false
                  );
                ...
                if (KUtils.checkIsBasicType(t)) {
                  ...
                  // 判断是否包含format
                  var responsecodeformat = KUtils.propValue(
                    "format",
                    schema,
                    ""
                  );
                  if (KUtils.strNotBlank(responsecodeformat)) {
                    _tmpSchemaName =
                      _tmpSchemaName + "(" + responsecodeformat + ")";
                  }
        ...
        if (rptype != null) {
          ...
          if (def != null) {
            if (arr) {
              ...
              swaggerResp.responseValue = KUtils.json5stringifyFormat(
                na,
                null,
                "\t"
              );
            ...
            if (def.hasOwnProperty("properties")) {
              ...
              props.forEach(function (p) {
                ...
                if (
                  !KUtils.checkParamArrsExists(
                    swaggerResp.responseParameters,
                    resParam
                  )
                ) {
                  swaggerResp.responseParameters.push(resParam);
                  resParam.description = KUtils.replaceMultipLineStr(
                    p.description
                  );
                  if (p.type == null || p.type == "") {
                    if (p.refType != null) {
                      if (!KUtils.checkIsBasicType(p.refType)) {
                        ...
                        var deepDef = that.getDefinitionByName(
                          p.refType,
                          swpinfo.oas2
                        );
                        let _tmpSchemaValue = deepDef != null ? deepDef : p;
                        deepResponseRefParameter(
                          swaggerResp,
                          that,
                          _tmpSchemaValue,
                          resParam
                        ...
                        deepTreeTableResponseRefParameter(
                          swaggerResp,
                          that,
                          _tmpSchemaValue,
                          resParam
        ...
        if (rescrobj.hasOwnProperty("headers")) {
          ...
          if (status == "200") {
            swpinfo.responseHeaderParameters =
              swaggerResp.responseHeaderParameters;
          }
        }
      ...
      for (var i = 0; i < that.currentInstance.difArrs.length; i++) {
        ...
        if (ref.name == definitionType) {
          ...
          if (arr) {
            ...
            swpinfo.responseValue = KUtils.json5stringifyFormat(
              ref.value,
              null,
              "\t"
            );
      ...
      if (def != null) {
        if (def.hasOwnProperty("properties")) {
          ...
          props.forEach(function (p) {
            ...
            resParam.name = p.name;
            if (
              !KUtils.checkParamArrsExists(swpinfo.responseParameters, resParam)
            ) {
    ...
    if (swpinfo.parameters != null) {
      ...
      if (count == 1) {
        ...
        if (KUtils.arrNotEmpty(swpinfo.consumes)) {
          var notEmptyConsumes = swpinfo.consumes.filter((consume) =>
            KUtils.strNotBlank(consume)
          );
          if (KUtils.arrNotEmpty(notEmptyConsumes)) {
            var xmlRequest = notEmptyConsumes.some(
              (consume) => consume.toLowerCase().indexOf("xml") > -1
            );
            if (xmlRequest) {
              // 是Xml请求
              ...
              //处理当前数据的ignore规则
              if (
                KUtils.checkUndefined(swpinfo.ignoreParameters) ||
                KUtils.checkUndefined(swpinfo.includeParameters)
              ) {
                console.log("处理当前数据的ignore规则");
                let _tmpIgnoreValue = KUtils.ignoreJsonValue(
                  KUtils.json5parse(tmpJsonValue),
                  swpinfo.ignoreParameters,
                  swpinfo.includeParameters
                );
 ...
 */
SwaggerBootstrapUi.prototype.bodyParameterResolverSchema = function (
  schema,
  swagger2
) {
  let that = this;
  ...
  if (KUtils.checkUndefined(type)) {
    ...
    if (type == "object") {
      ...
      originalOpenApiParameter = Object.assign({}, originalOpenApiParameter, {
        default: "{}",
      });
    }
 ...
 * @param {*} apiInfo
 */
SwaggerBootstrapUi.prototype.pluginSupportOrangeforms = function (
  swpinfo,
  apiInfo
) {
  if (apiInfo.hasOwnProperty("x-orangeforms")) {
    ...
    if (
      KUtils.checkUndefined(oa3Data) &&
      KUtils.checkUndefined(oa3Data.components)
    ) {
    ...
    let orangeformsIgnoreParameters =
      apiInfo["x-orangeforms-ignore-parameters"];
    if (KUtils.checkUndefined(orangeformsIgnoreParameters)) {
      swpinfo.enterprisePlugins.orangeformsIgnoreParameters =
  ...
  if (!swpinfo.init) {
    ...
    if (apiInfo.hasOwnProperty("parameters")) {
      ...
      pameters.forEach((m) => {
        ...
        if (_enterpriseSchema) {
          ...
          if (
            swpinfo.enterprisePlugins.orangeformsIgnoreParameters.includes(
              originalName
            )
          ) {
            return;
    ...
    if (apiInfo.hasOwnProperty("requestBody")) {
      ...
      if (KUtils.checkUndefined(bodyParameter)) {
        if (
          bodyParameter.hasOwnProperty("content") &&
          KUtils.checkUndefined(bodyParameter["content"])
        ) {
          var bodyContent = bodyParameter["content"];
          for (var consume in bodyContent) {
            var consumeBody = bodyContent[consume];
            if (
              KUtils.checkUndefined(consumeBody) &&
              consumeBody.hasOwnProperty("schema")
            ) {
              if (swpinfo.enterprisePlugins.orangeforms) {
                //console.log("企业级插件orangeforms.")
                // 此处有可能是array类型
                let _enterpriseSchema =
                  swpinfo.enterprisePlugins.orangeformsSchema;
                if (KUtils.checkUndefined(_enterpriseSchema)) {
                  let _enterpriseParam = that.bodyParameterResolverSchema(
                    _enterpriseSchema,
                    swpinfo.oas2
                  );
                ...
                if (
                  ...
                  KUtils.checkUndefined(schema["properties"])
                ) {
                  ...
                  if (
                    ...
                    KUtils.checkUndefined(schema["required"])
                  ) {
                  ...
                  // 此处有可能是array类型
                  let originalOpenApiParameter =
                    that.bodyParameterResolverSchema(schema, swpinfo.oas2);
                  if (KUtils.checkUndefined(originalOpenApiParameter)) {
                    that.assembleParameterOAS3(
                      originalOpenApiParameter,
                      swpinfo,
                      []
                    );
                  }
          ...
          if (KUtils.arrNotEmpty(swpinfo.consumes)) {
            var xmlConsume = swpinfo.consumes.filter(
              (consume) => consume.indexOf("xml") > -1
            );
    ...
    if (typeof apiInfo.responses != "undefined" && apiInfo.responses != null) {
      ...
      for (var status in resp) {
        ...
        // 3.0判断content
        if (
          rescrobj.hasOwnProperty("content") &&
          KUtils.checkUndefined(rescrobj["content"])
        ) {
          ...
          for (var ckey in content) {
            ...
            if (
              respContentProduces.hasOwnProperty("schema") &&
              KUtils.checkUndefined(respContentProduces["schema"])
            ) {
                ...
                if (t == "array") {
                  ...
                  if (schema.hasOwnProperty("properties")) {
                    ...
                    for (var property in properties) {
                      ...
                      var propobj = properties[property];
                      spropObj.originProperty = propobj;
                      spropObj.type = KUtils.propValue(
                        "type",
                        propobj,
                        "string"
                      );
                      ...
                      // spropObj.example = KUtils.propValue('example', propobj, '');
                      spropObj.example = KUtils.getExample(
                        "example",
                        propobj,
                        ""
                      );
              ...
              responseExample = new Knife4jOAS3ResponseExampleReader(
                respContentProduces
              );
            }
            if (KUtils.checkUndefined(_tempExamples)) {
              //取最高优先级
              responseExample = new Knife4jOAS3ResponseExamplesReader(
                respContentProduces
              );
            }
    ...
    if (swpinfo.parameters != null) {
      ...
      // 判断consumes请求类型
      if (
        swpinfo.consumes != undefined &&
        swpinfo.consumes != null &&
        swpinfo.consumes.length > 0
      ) {
 ...
 */
SwaggerBootstrapUi.prototype.createApiInfoInstance = function (
  path,
  mtype,
  apiInfo,
  appendBaePathFlag
  ...
  if (KUtils.checkUndefined(that.configuration.supportedSubmitMethods)) {
    if (
      !that.configuration.supportedSubmitMethods.includes(mtype.toLowerCase())
    ) {
  ...
  if (apiInfo != null) {
    ...
    this.readOpenApiSpeci(
      path,
      swpinfo,
      apiInfo,
      that.currentInstance.swaggerData,
      that.currentInstance.openApiBaseInfo
    );
    ...
    swpinfo.consumes = KUtils.getValue(
      apiInfo,
      "consumes",
    ...
    swpinfo.tags.forEach(function (tag) {
      // 使用id确保唯一性，解决重复operationId导致的覆盖问题
      var _hashUrl =
        "#/" +
        _groupName +
        "/" +
 ...
 * @param {*} swaggerData
 */
SwaggerBootstrapUi.prototype.readOpenApiSpeci = function (
  path,
  swpinfo,
  apiInfo,
  swaggerData,
 ...
 * @param {*} swaggerData
 */
SwaggerBootstrapUi.prototype.readOpenApiSpeciOAS2 = function (
  apiInfo,
  swaggerData
) {
  var definitionCopy = {};
 ...
 * @param {*} swaggerData
 */
SwaggerBootstrapUi.prototype.readOpenApiSpeciOAS3 = function (
  apiInfo,
  swaggerData
) {
  var definitionCopy = {};
 ...
 * @param {*} apiInfo
 */
SwaggerBootstrapUi.prototype.readApiInfoInstanceExt = function (
  swpinfo,
  apiInfo
) {
  if (swpinfo.oas2) {
 ...
 * @param {*} apiInfo
 */
SwaggerBootstrapUi.prototype.readApiInfoInstanceExtOAS2 = function (
  swpinfo,
  apiInfo
) {
 ...
 * @param {*} apiInfo
 */
SwaggerBootstrapUi.prototype.readApiInfoInstanceExtOAS3 = function (
  swpinfo,
  apiInfo
) {
  // 获取扩展属性
  if (
    apiInfo.hasOwnProperty("extensions") &&
    KUtils.checkUndefined(apiInfo["extensions"])
  ) {
...
SwaggerBootstrapUi.prototype.assembleParameter = function (m, swpinfo) {
  ...
  minfo.description = KUtils.replaceMultipLineStr(
    KUtils.propValue("description", m, "")
  );
  ...
  if (m.hasOwnProperty("enum")) {
    ...
    minfo.description = KUtils.enumAvalibleLabel(
      that.i18nInstance,
      m.enum,
      m.description
    );
    ...
    if (isUndefined(minfo.txtValue) || isNull(minfo.txtValue)) {
      ...
      const newValue = (() => {
        if (isObject(minfo.value)) {
          ...
          // 判断include是否不为空
          if (swpinfo.includeParameters != null) {
            cloneValue = new IncludeAssemble(
              tmpJson,
              swpinfo.includeParameters
            ).result();
          } else {
      ...
      if (isUndefined(newValue) || isNull(newValue)) {
        ...
        minfo.txtValue = KUtils.json5stringify(
          minfo.type === "array" ? [newValue] : newValue,
          null,
          "\t"
        );
      }
  ...
  if (minfo.in == "query" || minfo.in == "formData") {
    if (minfo.schema) {
      ...
      if (
        KUtils.checkUndefined(minfo.value) &&
        KUtils.strBlank(minfo.txtValue)
      ) {
        minfo.txtValue = KUtils.json5stringify(
          minfo.type === "array" ? [minfo.value] : minfo.value,
          null,
          "\t"
        );
      }
 ...
 */
SwaggerBootstrapUi.prototype.assembleParameterOAS3 = function (
  m,
  swpinfo,
  requireArray
) {
  ...
  if (m.hasOwnProperty("enum")) {
    ...
    minfo.description =
      m.description +
      KUtils.enumAvalibleLabel(that.i18nInstance, m.enum, m.description);
  }
  // 判断你是否有默认值(后台)
  if (m.hasOwnProperty("default")) {
    minfo.txtValue = m["default"];
  ...
  if (m.hasOwnProperty("schema")) {
    ...
    var schemaType = schemaObject["type"];
    minfo.type = schemaType;
    let _tempSchemaParamDesc = KUtils.propValue(
      "description",
      schemaObject,
      null
    );
 ...
 * @param {*} oas 是否v2版本
 */
SwaggerBootstrapUi.prototype.findRefDefinition = function (
  definitionName,
  definitions,
  flag,
  globalArr,
  ...
  var defaultValue = "";
  if (
    KUtils.checkUndefined(that.currentInstance.definitionValues[definitionName])
  ) {
...
function deepResponseRefParameter(swpinfo, that, def, resParam) {
  if (def != null) {
    if (def.hasOwnProperty("properties")) {
      ...
      if (
        !KUtils.checkParamArrsExists(swpinfo.responseRefParameters, refParam)
      ) {
...
function deepTreeTableResponseRefParameter(swpinfo, that, def, resParam) {
  if (def != null) {
    if (def.hasOwnProperty("properties")) {
      ...
      if (
        !checkParamTreeTableArrsExists(
          swpinfo.responseTreetableRefParameters,
          refParam
        )
      ) {
...
function deepTreeTableRefParameter(minfo, that, def, apiInfo, oas2) {
  if (def != null) {
    // 查询
    if (
      KUtils.checkUndefined(that.currentInstance.refTreeTableModels[def.name])
    ) {
      // 存在
      ...
      if (
        !checkParamTreeTableArrsExists(apiInfo.refTreetableparameters, refParam)
      ) {
        // firstParameter.childrenTypes.push(def.name);
        apiInfo.refTreetableparameters.push(refParam);
        ...
        if (def.hasOwnProperty("properties")) {
          ...
          props.forEach(function (p) {
            ...
            if (
              apiInfo.ignoreParameters == null ||
              (apiInfo.ignoreParameters != null &&
                !apiInfo.ignoreParameters.hasOwnProperty(_ignoreFilterName))
            ) {
              var refp = new SwaggerBootstrapUiParameter();
              refp.pid = minfo.id;
...
var SwaggerBootstrapUiResponseCode = function () {
  (this.oas2 = false), (this.code = null);
  ...
  this.responseDescriptionFind = function (paths, key, that) {
    if (!this.responseDescriptions) {
      this.responseDescriptions = getKeyDescriptions(
        ...
        if (typeof objc == "object") {
          ...
          if (objc.schemaValue || objc.refType) {
            ...
            if (parentTypes.indexOf(objc.schemaValue || objc.refType) == -1) {
              ...
              var def = that.getDefinitionByName(
                objc.schemaValue || objc.refType
              );
              if (def) {
                if (def.properties) {
                  // 递归存在相互引用的情况,导致无限递归
                  keyListTemp = getKeyDescriptions(
                    def.properties,
                    that,
                    parentTypes
                  );
...
SwaggerBootstrapUiInstance.prototype.getOASDefinitions = function () {
  ...
  if (this.oas2()) {
    if (
      KUtils.checkUndefined(swaggerData) &&
      swaggerData.hasOwnProperty("definitions")
    ) {
    ...
    if (
      KUtils.checkUndefined(swaggerData) &&
      swaggerData.hasOwnProperty("components")
    ) {
      var components = swaggerData["components"];
      if (
        KUtils.checkUndefined(components) &&
 ...
 * 根据类名查找definition
 */
SwaggerBootstrapUiInstance.prototype.getDefinitionByName = function (
  name,
  oas
) {
  var that = this;
...
/**
 * Normalize OAS3 schemas: convert property with single allOf -> $ref
 * and optionally merge multiple allOf.
 */
SwaggerBootstrapUi.prototype.normalizeOAS3AllOf = function (swaggerData) {
  if (
    !swaggerData ||
  ...
  Object.keys(schemas).forEach((schemaName) => {
    ...
    Object.keys(schema.properties).forEach((propName) => {
      ...
      if (!prop || !prop.allOf || !Array.isArray(prop.allOf)) return;

      if (prop.allOf.length === 1 && prop.allOf[0].$ref) {
        // 单一 allOf: 转换成 $ref
        const seg = prop.allOf[0];
        const newProp = { $ref: seg.$ref };
        if (prop.description) newProp.description = prop.description;
        if (prop.example !== undefined) newProp.example = prop.example;
        schema.properties[propName] = newProp;
      } else {
        // 多个 allOf: 合并属性
        const merged = { type: "object", properties: {} };
        prop.allOf.forEach((seg) => {
          if (seg.$ref) {
            const refName = seg.$ref.replace("#/components/schemas/", "");
            const refSchema = schemas[refName];
            if (refSchema && refSchema.properties) {
              Object.assign(merged.properties, refSchema.properties);
            }
          } else if (seg.properties) {
            Object.assign(merged.properties, seg.properties);
          }
        });
        if (prop.description) merged.description = prop.description;
        if (prop.example !== undefined) merged.example = prop.example;
        schema.properties[propName] = merged;
      }
    });
  });
};
